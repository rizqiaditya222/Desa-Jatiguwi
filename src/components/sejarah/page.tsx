    ...
    <div className=" px-24 py-16">
      ...
      <div className="text-[#333] text-xl max-w-360 mx-auto leading-relaxed text-justify">
        ...
        <p className="text-balance">
          ...
          <b>pohon jati</b>, diantara pohon jati yang tumbuh tersebut ada sebuah
          ...
          dalam istilah Jawa biasa disebut <b>Growong</b>. pada suatu ketika
          pemerintah hindia Belanda membangun penjara (Bui) dan membutuhkan
          ...
          kawasan itu sebutannya menjadi <b>JATIGUWI</b>. Sudah menjadi
          kebiasaan masyarakat Jawa bahwa untuk memberi nama sesuatu tempat
          ...
          <b>JATIGUWI</b>. Karena letaknya yang strategis berada pada daerah
          ...
          menjadi kawasan yang cukup ramai. Wilayah Jatiguwi meliputi : Krajan,
          Mentaraman, Jatimulyo (Kebon Klopo), Singodrono.
        </p>
      </div>
    </div>
  );
