  ...
  return (
    <div className='flex flex-col items-center text-center pt-10'>
        ...
        <div className='py-7'>
            ...
            <p className='font-bold text-4xl text-[#0E4D45]'>Kecamatan Sumberpucung, Kabupaten Malang</p>  
        </div>
        <p className='w-1/2 text-xl'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
