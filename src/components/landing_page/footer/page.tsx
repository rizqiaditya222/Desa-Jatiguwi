...
const Footer = () => {
  return (
    <div className="w-full flex flex-col bg-[#0E4D45] px-16 py-8">
      <section className="border-b-1 flex gap-8 pb-8 border-white">
        <section className="flex-1/2 flex flex-col space-y-4">
        ...
        <section className="flex-1/12 flex justify-end">
          <div>
        ...
        <section className="flex-1/12 flex justify-center">
